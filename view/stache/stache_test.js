...
//        }
		...
		test('Falsey values are rendered with helpers (#1109)', function() {
			var renderer = can.stache('{{myHelper}}');
			var frag = renderer({}, {
				myHelper: function() {
					return 0;
				}
			...
			strictEqual(frag.firstChild.nodeValue, '0', 'falsey value is rendered');
		});
